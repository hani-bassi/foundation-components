...
function completeRepoSetup()  {
	...
	helper.moveFile('test/_element.visual-diff.html', `test/${helper.getShortName()}.visual-diff.html`);
	helper.moveFile('test/_element.visual-diff.js', `test/${helper.getShortName()}.visual-diff.js`);
