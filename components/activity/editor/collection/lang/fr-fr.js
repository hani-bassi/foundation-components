...
export default {
	...
	"button-loadMore": "Charger plus", // When adding activities to the learning path, this is on a button that will load more potential activities that can be added that match the current search.
	...
	"dialog-selected": "{count} sélectionné(e)(s).", // When adding activities (bulk add) to a learning path this is the number of activities that will be added to the list.
